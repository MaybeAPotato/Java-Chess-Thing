...
public class pieceKing implements chessInterface{
    /*
    ...
    */
    ...
    public boolean checkMove(int _nX, int _nY){ //Checks to see if move is possible
        onBoard(_nX, _nY);
        if (_nX == nX && (_nY == nY + 1 || _nY == nY - 1))
            return true;
        else if (_nY == nY && (_nX == nX + 1 || _nX == nX - 1))
            return true;
        else if ((_nX == nX + 1 || _nX == nX - 1) && (_nY == nY + 1 || _nY == nY - 1))
            return true;
        else return false;
    }
